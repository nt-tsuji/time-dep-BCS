...
The code solves the time evolution of the pseudospins and gap function using the second-order ([time_dep_BCS_RK2.jl](/src/time_dep_BCS_RK2.jl)) and fourth-order (time_dep_BCS_RK4.jl) implicit Runge-Kutta method.
